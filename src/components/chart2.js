...
class Chart2 extends Component {
    ...
    for (let i = 0; i < 30; i++) {
      ...
      // console.log(day);
      let dayAmount = 0, dayAmountIncome=0;
      for (let j = 0; j < data.length; j++) {
        // console.log("data amount",data[j].amount);
        let clientTime = new Date(data[j].date);
        if (clientTime.getFullYear() === day.getFullYear() 
    ...
    render() { 
        ...
        return (
            <div>
              CHARTS
              <LineChart width={600} height={300} data={this.state.dataForChart}
       ...
       <Tooltip/>
       <Legend />
       <Line type="monotone" dataKey="amount" stroke="#8884d8" dot={<CustomizedDot />}/>
